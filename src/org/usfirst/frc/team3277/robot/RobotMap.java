...
public class RobotMap {
	 ...
	 */
	public final static int OPERATOR_INPUT_DEVICE_JOYSTICK = 0,
			OPERATOR_INPUT_DEVICE_CONTROLLER = 1;
	 ...
	 * reference.
	 */
	public final static int FRONT_LEFT_DRIVE = 1, FRONT_RIGHT_DRIVE = 2,
			REAR_LEFT_DRIVE = 3, REAR_RIGHT_DRIVE = 4;
	...
	// REGISTERS
	public final static byte HMC5883_REGISTER_MAG_CRA_REG_M = 0x00,
	...
	// Constants
	public final static int SENSORS_GAUSS_TO_MICROTESLA = (100); /**< Gauss to micro-Tesla multiplier */

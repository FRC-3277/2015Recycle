...
public class Logger 
{
    ...
    /**
	 * The log method puts Numerical information of interest from the subsystem to the SmartDashboard.  Useful in
	 * dashLog() methods.
	 */
    ...
    /**
     * Log errors to the SmartDashboard.  Only one error will be represented at a time which may mask 
     * multiple errors.  Particularly useful in cases where logging in catch blocks.
     */

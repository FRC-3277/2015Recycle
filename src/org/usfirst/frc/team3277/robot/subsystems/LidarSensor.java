...
/**
 * The LIDAR sensor is for distance measurement. This code was sourced from:
 * https://gist.github.com/anonymous/4aac6d39f0de0e0faac0 Note - a forked, FRC
 * team tech2077, version exists at:
 * https://gist.github.com/tech2077/c4ba2d344bdfcddd48d2 Important - We
 * experienced failure to acquire data like many posts read about the kOnboard
 * i2c. We had success with the MXP connector.
 */
public class LidarSensor extends Subsystem implements PIDSource
{
	...
	public void update()
	{
		...
		i2c.read(RobotMap.LIDAR_DISTANCE_REGISTER, 2, distance); // Read in
																	// measurement

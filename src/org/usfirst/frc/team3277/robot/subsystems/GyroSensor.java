...
/**
 * Uses the ADW22307 gyro and the built in wpilibj logic adding additional functionality such as logging.
 */
public class GyroSensor extends Subsystem {
	...
	/**
	 * @return The current angle of the drivetrain relative to the the time the bot was powered up.
	 */
    ...
    /**
	 * @return The current angle of the drivetrain relative to the the time the bot was powered up in a human readable format (0-360 degrees).
	 */
	public double getHumanReadableAngle() {
		// Absolute value desired since turning counterclockwise returns negative degrees after passing 0.  Modulus to keep it relative to full 360 degrees
		// that can represent 
